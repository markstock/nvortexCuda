...
#NVCC=$(CUDA_BIN)/nvcc
NVCC=nvcc
# 80 is the A100, 86 is the 370Ti
...
all : nvCuda01.bin nvCuda02.bin nvCuda03.bin nvCuda04.bin ngCuda03.bin ngCuda04.bin

%.bin : %.cu
	$(NVCC) $(ARCH) $(NVCCFLAGS) -Xcompiler "$(CXXFLAGS)" -o $@ $^

clean :
	rm nvCuda01.bin nvCuda02.bin nvCuda03.bin nvCuda04.bin ngCuda03.bin ngCuda04.bin
